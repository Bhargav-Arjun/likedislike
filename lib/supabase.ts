...
if (!supabaseUrl || !supabaseAnonKey) {
  ...
  console.warn(
    'Supabase env vars are missing. Set NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY in Vercel > Settings > Environment Variables, then redeploy.'
  );
}
